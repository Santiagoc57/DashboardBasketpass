...
import {
  TeamCoverageField,
  type TeamCoverageOption,
} from "@/components/people/team-coverage-field";
...
export function CreatePersonModal({
  ...
  redirectTo: string;
  roleOptions: string[];
  teamOptions: TeamCoverageOption[];
}) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        ...
        >
          <div
            className="relative flex max-h-[calc(100vh-2rem)] w-full max-w-[1160px] flex-col overflow-hidden rounded-[var(--panel-radius)] border border-[#e6e8ec] bg-white shadow-[0_32px_80px_rgba(15,23,42,0.26)]"
              ...
              <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto bg-[#faf7f7]">
                ...
                <div>
                  <section className="border-b border-[#f1f3f5] bg-white px-8 py-8">
                    ...
                    <div className="grid gap-8 xl:grid-cols-[220px_minmax(0,1fr)_300px] xl:items-start">
                      <aside className="space-y-5">
                        <div className="flex flex-col items-center rounded-[var(--panel-radius)] border border-[#eef2f6] bg-[#fbfcfe] px-5 py-6 text-center">
                          ...
                          <div className="mt-5 space-y-1">
                            ...
                            <p className="text-sm leading-6 text-[#667085]">
                              JPG o PNG. Tamaño máximo sugerido: 2 MB.
                            </p>
                          </div>
                          ...
                          <div className="mt-5 flex w-full flex-col gap-2">
                            <button
                              ...
                              onClick={() => fileInputRef.current?.click()}
                              disabled={!canEdit}
                              className="inline-flex h-11 items-center justify-center gap-2 rounded-[var(--panel-radius)] border border-[#e5e7eb] bg-[#f8fafc] px-4 text-sm font-semibold text-[#475467] transition hover:bg-[#eef2f6] disabled:cursor-not-allowed disabled:opacity-60"
                            >
                            ...
                            <button
                              ...
                              className="inline-flex h-11 items-center justify-center gap-2 rounded-[var(--panel-radius)] px-4 text-sm font-semibold text-[var(--accent)] transition hover:bg-[rgba(230,18,56,0.05)] disabled:cursor-not-allowed disabled:opacity-50"
                            >
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                          ...
                          <div className="space-y-4 md:col-span-2">
                            <ModalFieldLabel required>Roles</ModalFieldLabel>
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                              <label className="space-y-2">
                                <span className="text-xs font-semibold uppercase tracking-[0.16em] text-[#667085]">
                                  Rol principal
                                </span>
                        ...
                        <label className="space-y-2">
                          <ModalFieldLabel>Responsable de equipo</ModalFieldLabel>
                          <TeamCoverageField
                            name="coverageTeams"
                            options={teamOptions}
                            placeholder="Escribe uno o varios equipos..."
                            disabled={!canEdit}
                            className={fieldClassName}
                            helperText="Puedes agregar varias opciones separadas por coma para ver sugerencias de equipos."
                          />
                        </label>
                      </div>

                      <label className="flex flex-col gap-2 xl:min-h-[26rem]">
                        <ModalFieldLabel>Notas</ModalFieldLabel>
                        <Textarea
                          name="notes"
                          placeholder="Añade cualquier detalle relevante sobre el perfil del colaborador..."
                          disabled={!canEdit}
                          className="min-h-[200px] flex-1 rounded-[var(--panel-radius)] border-[#e5e7eb] bg-[#f9f9f9] text-[15px] font-medium text-[#1f2937] placeholder:text-[#98a2b3] shadow-[inset_0_2px_4px_rgba(15,23,42,0.04)] focus:border-[var(--accent)] focus:bg-white focus:ring-[3px] focus:ring-[rgba(230,18,56,0.08)]"
                        />
                      </label>
                    </div>
                  </section>
